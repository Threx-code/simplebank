...
func (q *Queries) CreateEntries(ctx context.Context, arg CreateEntriesParams) (Entery, error) {
...
func (q *Queries) GetEntries(ctx context.Context, id int64) (Entery, error) {
